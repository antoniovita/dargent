...
interface IStrategyRegistry {
    ...
    event StrategyRiskSet(address indexed implementation, uint32 riskScore, bool isLiquid);
    ...
    function setRisk(address implementation, uint32 newRiskScore, bool newIsLiquid) external;
